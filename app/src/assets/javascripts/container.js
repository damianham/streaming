          ...
          <div className="container">
            <nav className="nav">
              ...
              {this.isAuthenticated() && this.state.current_user ? (
                  <div className='nav-item nav-item-auth nav-item-auth-signout' onClick={this.signOut}>Sign Out</div>
                ) : (
                  <a className='nav-item nav-item-auth nav-item-auth-signin' href='/signin'>Sign In</a>
                )
              }
              {this.isAuthenticated() && this.state.current_user ? (
                  <Link className='nav-item nav-item-auth nav-item-auth-profile' to='/profile'>{this.state.current_user.email}</Link>
                ) : (
